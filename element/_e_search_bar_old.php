...
<?php if ($year_list) { ?>				
					<div class="card ml-2 mr-2 mt-2" style="<?php echo $hidden;?>">
						<div class="shadow">
							...
							<div class="card-body form-group p-2">
								<select name="start_year" class="custom-select mr-1">
									<?php
								...
								<select name="start_month" class="custom-select mr-1">
									<?php
									for($i=1;$i<=12;$i++) {
									?>
					...
					<div class="card ml-2 mr-2 mt-2" style="<?=$hidden;?>">
						<div class="shadow">
							...
							<div class="card-body form-group p-2">
								<select name="end_year" class="custom-select mr-1">
									<?php
									foreach($year_list AS $year) {
									?>
								...
								<select name="end_month" class="custom-select mr-1">
									<?php
									for($i=1;$i<=12;$i++) {
									?>
