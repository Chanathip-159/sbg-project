...
<div class="modal fade" id="addEditCustomerAccModal" tabindex="-1" role="dialog" aria-labelledby="addEditCustomerAccModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="dialog">
		<div class="modal-content">
			<div class="modal-header justify-content-center font-weight-bold bg-primary text-white" id="add-edit-customer-modal-header">Add new keyword</div>
...
$('#addEditCustomerAccModal').on('show.bs.modal', function(e) {
	...
	if (user_id.substr(0, 4) == "del-") {
		...
		document.getElementById("add-edit-customer-modal-header").innerHTML="Add new keyword";
