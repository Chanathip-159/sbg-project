	...
	<div class="modal-dialog modal-lg" role="dialog">
		<div class="modal-content">
			...
			<div class="modal-body edit-content">
				<form role="form" name="form_acc_edit_acc" action="<?=_MAIN_DF;?>first" method="post" onsubmit="return validateAddEditCustomerAccModal();">
					<div class="form-row">
...
$('#addEditCustomerAccModal').on('show.bs.modal', function(e) {
	...
	form_acc_edit_acc.action = "<?=_MAIN_DF;?>first";
	...
	if (load_sub) {
		$.ajax({
			cache: false,
			type: 'POST',
			url: 'element/_p_dialog_edit_sub_form.php',
