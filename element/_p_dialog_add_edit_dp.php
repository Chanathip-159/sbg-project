...
<div class="modal fade" id="EditChangeDelModal" tabindex="-1" role="dialog" aria-labelledby="EditChangeDelModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="dialog">
		<div class="modal-content">
			<div class="modal-header justify-content-center font-weight-bold bg-primary text-white" id="add-edit-sender-modal-header">New keyword</div>
			<div class="modal-body edit-content">
				<form role="form" name="form_acc_edit_acc" action="<?=_MAIN_DF;?>keyword" method="post" onsubmit="return validateEditChangeDelModal();">
					<div class="form-row">
...
$('#EditChangeDelModal').on('show.bs.modal', function(e) {
	...
	form_acc_edit_acc.action = "<?=_MAIN_DF;?>department";
	if (user_id.substr(0, 4) == "del-") {
		...
		document.getElementById("add-edit-sender-modal-header").innerHTML="Delete department : "+user_id.split("-")[1];
		...
		document.getElementById("add-edit-sender-modal-header").innerHTML="Edit department : "+user_id;
	...
	if (load_sub) {
		$.ajax({
			cache: false,
			type: 'POST',
			url: 'element/_p_dialog_add_edit_dp_form.php',
