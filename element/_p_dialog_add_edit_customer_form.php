						...
						<div class="form-row justify-content-center text-center">	
							<div class="col-md-6">
								<div class="form-group" id="checkError_user">
									...
									<input class="form-control text-center" name="CUSTOMER_Username" id="CUSTOMER_Username" value="<?=$user_id;?>" <?=($user_id == $_SESSION[_SES_USR_NAME] ? 'disabled' : '')?> />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-control-label mb-0">Category</label>
									<select class="form-control" name="CUSTOMER_Category" <?=($_SESSION[_SES_USR_TYP_ID]>_ADMIN_L?"disabled":"")?>>
									<?php
						...
						<div class="form-row justify-content-center text-center">	
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name="CUSTOMER_Status" <?=($_SESSION[_SES_USR_TYP_ID]>_ADMIN_L?"disabled":"")?>>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-control-label mb-0">Department *</label>
									<select class="form-control" name="CUSTOMER_Department" <?=($_SESSION[_SES_USR_TYP_ID]>_ADMIN_L?"disabled":"")?>>
									<?php
										$sql = "SELECT [DEPARTMENT_Id], [DEPARTMENT_Name] FROM [SBG].[dbo].[DEPARTMENT]";
										if ($stmt = querySqlEx($sql)) {
											while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
										?>
											<option value="<?=$row['DEPARTMENT_Id'];?>" <?=($acc['CUSTOMER_Department']==$row['DEPARTMENT_Name']?'selected':'');?> > <?=$row['DEPARTMENT_Id']." : ".$row['DEPARTMENT_Name'];?></option>
										<?php
											}
										}
									?>
						...
						<div class="form-row justify-content-center text-center">
							<div class="col-md-6">
								<div class="form-group" id="checkError_person">
									...
									<input class="form-control" name="CUSTOMER_Contact" id="CUSTOMER_Contact" value="<?=$acc['CUSTOMER_Contact']?>" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group" id="checkError_phone">
									<label class="form-control-label mb-0">Phone No. *</label>
									<input class="form-control" name="CUSTOMER_Telephone" id="CUSTOMER_Telephone" value="<?=$acc['CUSTOMER_Telephone']?>" />
								</div>
							</div>
						</div>
						<div class="form-row justify-content-center text-center">	
							<div class="col-md-6">
								<div class="form-group" id="checkError_email">
									...
									<input class="form-control" name="CUSTOMER_Email" id="CUSTOMER_Email" value="<?=$acc['CUSTOMER_Email']?>" />
								</div>
								<div class="form-group" id="checkError_email">
									<label class="form-control-label mb-0">Send To</label>
									<select class="form-control" name="CUSTOMER_DES">
										<option value="0" <?=($acc['CUSTOMER_DES']=="0"?'selected':'');?>>0 : All</option>
										<option value="1" <?=($acc['CUSTOMER_DES']=="1"?'selected':'');?>>1 : NT Only</option>
									</select>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name="CUSTOMER_NeedDr">
								...
								<div class="form-group">
									<label class="form-control-label mb-0">Submit DR URL (CP site)</label>
									<input class="form-control" name="CUSTOMER_UrlDelivery" id="CUSTOMER_UrlDelivery" value="<?php echo $acc['CUSTOMER_UrlDelivery']?>" />
								</div>
							</div>
						</div>		
<?php
							...
							<div class="col-md-6">					
								<div class="form-group input-group mb-0"><!-- Start Date -->
									...
									<div class="form-group col-md-4">
										<select name="CUSTOMER_ActivateDate_year" class="custom-select">
<?php
...
?>
									...
									<div class="form-group col-md-5">
										<select name="CUSTOMER_ActivateDate_month" class="custom-select">
<?php
for($i=1;$i<=12;$i++) {
?>
...
?>
									...
									<div class="form-group col-md-3">
										<select name="CUSTOMER_ActivateDate_day" class="custom-select">
<?php
for($i=1;$i<=31;$i++) {
?>
...
?>
							...
							<div class="col-md-6">	
								<div class="form-group input-group"><!-- Expire Date --> 
									...
									<div class="form-group col-md-4">
										<select name="CUSTOMER_ExpireDate_year" class="custom-select">
<?php
for($year = $date_y_min; $year < date("Y")+10; $year++) {
?>
...
?>
									...
									<div class="form-group col-md-5">
											<select name="CUSTOMER_ExpireDate_month" class="custom-select">
<?php
for($i=1;$i<=12;$i++) {
?>
...
?>
									...
									<div class="form-group col-md-3">
											<select name="CUSTOMER_ExpireDate_day" class="custom-select">
<?php
for($i=1;$i<=31;$i++) {
?>
						...
						<div class="form-row justify-content-center text-center">
							<div class="col-md-2">
								<div class="form-group">
									...
									<select name="CUSTOMER_ChargeType_Apply" class="custom-select">
						...
						<div class="form-row justify-content-center text-center">
							<div class="col-md-6">
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" maxlength="500" name="CUSTOMER_Detail" id="CUSTOMER_Detail"><?=$acc['CUSTOMER_Detail']?></textarea>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-control-label mb-0">Admin Remark</label>
									<textarea class="form-control" rows="3" name="CUSTOMER_AdminComment" id="CUSTOMER_AdminComment" <?=($_SESSION[_SES_USR_TYP_ID]>_ADMIN_L?"disabled":"")?>><?=$acc['CUSTOMER_AdminComment']?></textarea>
								</div>
							</div>
						</div>
						<div class="form-row justify-content-center text-center">
							<div class="col-md-6">
								<div class="form-group" id="checkError_user">
									<label class="form-control-label mb-0">Root-user</label>
									<?php 
										$sql = "SELECT CUSTOMER_Parent_Username FROM SBG.dbo.CUSTOMERS WHERE CUSTOMER_Username='".$user_id."' ";
										if ($stmt = querySqlEx($sql)) {
											while ($row_root = $stmt->fetch(PDO::FETCH_ASSOC)) {
												if (isset($row_sub['CUSTOMER_Username'])) { 
										?>
											<input class="form-control text-center" name="CUSTOMER_Username" id="CUSTOMER_Username" value="<?=$row_root['CUSTOMER_Parent_Username'];?>" />
										<?php
											} else {
										?>
										<input class="form-control" value="*empty Root-user" disabled>
										<?php
												}
											}
										}
							...
							<div class="col-md-6">
								<div class="form-group" id="checkError_user">
									<label class="form-control-label mb-0">Sub-user</label>
									<?php 
										$sql = "SELECT CUSTOMER_Username FROM SBG.dbo.CUSTOMERS WHERE CUSTOMER_Parent_Username='".$user_id."' ";
										if ($stmt = querySqlEx($sql)) {
											while ($row_sub = $stmt->fetch(PDO::FETCH_ASSOC)) {
												if (isset($row_sub['CUSTOMER_Username'])) { 
									?>
									<input class="form-control" value="<?=$row_sub['CUSTOMER_Username']?>">
									<?php
										} else {
									?>
									<input class="form-control" value="*empty Sub-user" disabled>
									<?php
											}
										}
									}
